//! The oracle: a real libghostty-vt terminal, read out as a `vtr_snapshot::Snapshot`.
//!
//! Ghostty's terminal core is the reference implementation vtr is measured against. It
