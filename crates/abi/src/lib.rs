//! The C ABI ruuah-vt publishes, matching the subset of `libghostty-vt` the differential
//! harness verifies.
//!
//! This is the project's thesis made executable: a program compiled against
//! `ghostty/vt/*.h` can link `libruuah-vt.a` instead of `libghostty-vt.a`, because the
...
pub use ruuah_vt_abi_types as types;
pub use ruuah_vt_abi_types::*;
