...
//!
//! Slice 0 of ruuah-vt is a gate on this crate working, not on any terminal being written.
//! If an identical stream can be pushed through libghostty-vt and through ruuah-vt and the
